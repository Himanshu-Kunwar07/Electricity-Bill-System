...
public class Project extends JFrame implements ActionListener {
  Project(){
	...
	//---------------------------------------------------------------------------------------------
	 ...
	 ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/image8.png"));
	 ...
	 ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icon/image9.png"));
	 ...
	 ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/image10.png"));
	 ...
	 ImageIcon  icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/icon11.pnp"));
	 ...
	 setFont(new Font("Senserif", Font.BOLD, 15));
  ...
  public void actionPerformed(ActionEvent ae) {
	  ...
	  if(msg.equals("Customer Details")) {
		...
		try {
		  ...
		  try {
			  Runtime.getRuntime().exec("C:\\Program Files\\BraveSoftware\\Brave-Browser\\Brave.exe");
		  }catch(Exception e) { }
